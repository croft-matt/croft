  ...
  return (
    <div className="px-5 pt-5 pb-4 border-b border-border">
      <div className="flex items-center gap-2 mb-2">
        <span className="text-[13px] font-medium px-1.5 py-0.5 rounded bg-muted text-muted-foreground uppercase tracking-wide">
          {INTENT_LABEL[job.intent] ?? job.intent}
        </span>
        {roomName && (
          <span className="text-[13px] text-muted-foreground truncate">{roomName}</span>
        )}
      </div>
