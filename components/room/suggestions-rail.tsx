...
function SuggestionCard({
  ...
  function handleAccept() {
    startTransition(async () => {
      await acceptBlock(roomId, suggestion.type)
    })
  }

  function handleDismiss() {
    startTransition(async () => {
      await dismissBlock(roomId, suggestion.type)
    })
  }

  return (
    <div className="flex items-center justify-between gap-3 rounded-xl border border-dashed border-neutral-800 bg-neutral-900/50 px-4 py-3 opacity-80">
